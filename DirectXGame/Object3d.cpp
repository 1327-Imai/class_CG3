...
void Object3d::UpdateViewMatrix()
{
	...
	//カメラの位置からワールド原典へのベクトル(カメラ座標系)
	XMVECTOR tX = XMVector3Dot(cameraAxisX, reversEyePosition);
	XMVECTOR tY = XMVector3Dot(cameraAxisY, reversEyePosition);
	XMVECTOR tZ = XMVector3Dot(cameraAxisZ, reversEyePosition);
	//一つのベクトルにまとめる
